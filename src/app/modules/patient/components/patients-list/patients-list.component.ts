  ...
  public ngOnInit(): void {
    this.quickTable = this.quickTableBuilder
      ...
      .columns((builder) => [
        ...
        builder.init('firstName').label('Imię').width('12rem').build(),

        builder.init('lastName').label('Nazwisko').width('12rem').build(),

        builder.initNumber('age').label('Wiek').width('5rem').build(),

        builder.initCurrency('amount').label('Cena').width('8rem').build(),
